                                                    ...
                                                    <td>
                                                        <div class="product-cart d-flex align-items-center">
                                                            <div class="product-thumb">
                                                                <img src="{!! asset('public/backend/dist/assets/images/product/upload.png') !!}"
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-xxl-12 col-xl-12 col-lg-12">
                            <div class="img-container">
                                <img id="image"
                                    src="{!! asset('public/backend/dist/assets/images/product/cropimg-upload.jpg') !!}"
...
<script src="{!! asset('public/backend/dist/assets/plugin/multi-select/js/jquery.multi-select.js') !!}">
</script>
<script src="{!! asset('public/backend/dist/assets/plugin/bootstrap-tagsinput/bootstrap-tagsinput.js') !!}">
</script>
