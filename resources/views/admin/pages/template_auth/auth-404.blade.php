            ...
            <div class="w-100 p-3 p-md-5 card border-0 shadow-sm" style="max-width: 32rem;">
                ...
                <form class="row g-1 p-3 p-md-4">
                    <div class="col-12 text-center mb-4">
                        <img src="{!! asset('public/backend/dist/assets/images/not_found.svg') !!}" class="w240 mb-4"
                            alt="" />
                        <h5>OOP! PAGE NOT FOUND</h5>
                        <span class="">Sorry, the page you're looking for doesn;t exist. if you think something is
                            brlken, report a problem.</span>
                    </div>
