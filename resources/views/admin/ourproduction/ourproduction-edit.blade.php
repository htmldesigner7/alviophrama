...
@section('title', 'Our Production Edit')
...
<div class="container-xxl">
    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Our Production Edit</h3>
                <!--<button type="submit"-->
    ...
    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('ourproduction.update',$ourproduction->id) }}">
            @csrf
            @method('PATCH')
                ...
                <div class="col-lg-12">
                    <div class="card mb-3">
                        <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                            <h6 class="mb-0 fw-bold ">Our Production Details</h6>
                        </div>
                        <div class="card-body">
                            <div class="row g-3 align-items-center">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" name="cat_type" aria-label="Default select example">
                                        <option value="ourproduction" @if($ourproduction->cat_type ==
                                            'ourproduction') selected="selected" @endif>ourproduction</option>
                                        <option value="Ourresponsibility" @if($ourproduction->cat_type == 'Ourresponsibility') selected="selected" @endif>Ourresponsibility</option>
                                        
                                        <option value="Ourprinciple" @if($ourproduction->cat_type == 'Ourprinciple') selected="selected" @endif>Ourprinciple</option>
                                        <option value="Others" @if($ourproduction->cat_type == 'Others') selected="selected" @endif>Others</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="title" name="title" class="form-control"
                                        value="{{ $ourproduction->title }}" placeholder="ourproduction Title">
                                    @if ($errors->has('title'))
                                ...
                                <div class="col-md-6">
                                    @if($ourproduction->image)
                                        <img 
                                            src="{{ asset('public/ourproductionimage/' . $ourproduction->image) }}" 
                                            alt="ourproduction Image"
                                            style="width:120px; height:auto; border:1px solid #ddd; padding:5px;">
                                    @endif
                                </div>
                                <div class="col-md-12">
                                    <label for="description" class="form-label">Description</label>
                                    <textarea id="description" name="description" class="form-control" required>{!! $ourproduction->description !!}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
