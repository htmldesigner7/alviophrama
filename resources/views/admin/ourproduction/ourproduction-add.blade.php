...
@section('title', 'Our Production Add')
...
<div class="container-xxl">
    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">Our Production Add</h3>
                <!--<button type="submit"-->
    ...
    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('ourproduction.store') }}">
            @csrf
            <div class="row g-3 mb-3">
                <div class="col-lg-12ourproduction">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="row g-3 align-items-center">
                                ...
                                <select class="form-select" name="cat_type" aria-label="Default select example">
                                    <option value="ourproduction">ourproduction</option>
                                    <option value="Ourresponsibility">Ourresponsibility</option>
                                    <option value="Ourprinciple">Ourprinciple</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" id="title" name="title" class="form-control"
                                    placeholder="Our Production Title">
                                @if ($errors->has('title'))
