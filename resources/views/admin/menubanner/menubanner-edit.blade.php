...
@section('title', 'MenuBanner Details Edit')
...
<div class="container-xxl">
    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">MenuBanner Details Edit</h3>
                <!--<button type="submit"-->
    ...
    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('menubanner.update',$menubanner->id) }}">
            @csrf
            @method('PATCH')
                ...
                <div class="col-lg-12">
                    <div class="card mb-3">
                        <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                            <h6 class="mb-0 fw-bold ">MenuBanner Details Details</h6>
                        </div>
                        <div class="card-body">
                            <div class="row g-3 align-items-center">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="title" name="title" class="form-control"
                                        value="{{ $menubanner->title }}" placeholder="MenuBanner Details Title">
                                    @if ($errors->has('title'))
    ...
    <input type="text" id="url" name="url" class="form-control"
        value="{{ $menubanner->url }}" placeholder="MenuBanner Details Url">
    @if ($errors->has('url'))
    ...
    @endif
                                ...
                                <div class="col-md-6">
                                    @if($menubanner->image)
                                        <img 
                                            src="{{ asset('public/menubannerimage/' . $menubanner->image) }}" 
                                            alt="MenuBanner Details Image"
                                ...
                                <div class="col-md-12>
                                    ...
                                    <textarea id="description" name="description" class="form-control" required>{!! $menubanner->description !!}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
