...
@section('title', 'MenuBanner Details Add')
...
<div class="container-xxl">
    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">MenuBanner Details Add</h3>
                <!--<button type="submit"-->
    ...
    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('menubanner.store') }}">
            @csrf
            <div class="row g-3 mb-3">
                <div class="col-lg-12MenuBanner Details">
                    <div class="card mb-3">
                            ...
                            <div class="row g-3 align-items-center">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="title" name="title" class="form-control"
                                        placeholder="MenuBanner Details Title">
                                    @if ($errors->has('title'))
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="url" name="url" class="form-control"
                                        placeholder="MenuBanner Details Url">
                                    @if ($errors->has('url'))
