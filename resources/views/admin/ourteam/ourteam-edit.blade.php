...
<div class="container-xxl">
    ...
    <div class="row align-items-center">
        <div class="border-0 mb-4">
            <div
                ...
                <h3 class="fw-bold mb-0">OurTeam Edit</h3>
                <!--<button type="submit"-->
    ...
    <div class="card-body">
        <form method="post" enctype="multipart/form-data" action="{{ route('ourteam.update',$ourteam->id) }}">
            @csrf
            @method('PATCH')
                            ...
                            <div class="row g-3 align-items-center">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="title" name="title" class="form-control"
                                        value="{{ $ourteam->title }}" placeholder="ourteam Title">
                                    @if ($errors->has('title'))
                                ...
                                <div class="col-md-6">
                                    @if($ourteam->image)
                                        <img 
                                            src="{{ asset('public/ourteamimage/' . $ourteam->image) }}" 
                                            alt="ourteam Image"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea id="description" name="description" class="form-control" required>{!! $ourteam->description !!}</textarea>
                                </div>
                            </div>
